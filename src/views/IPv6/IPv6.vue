<template>
  <div class="button-container">
    <el-button type="primary" class="custom-button" @click="methods.menuItemClick('Insert')">IPv6注入和篡改</el-button>
    <el-button type="success" class="custom-button" @click="methods.menuItemClick('Deny')">IPv6拒绝服务攻击</el-button>
  </div>
</template>
